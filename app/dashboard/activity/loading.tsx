    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {[...Array(8)].map((_, i) => (
          <div
            key={i}
            className="flex items-center gap-4 p-4 rounded-2xl bg-bg-card dark:bg-zinc-900/50 border border-border-subtle dark:border-white/5"
          >
            <Skeleton className="w-12 h-12 rounded-xl bg-zinc-200 dark:bg-zinc-800 shrink-0" />
