...
export default function Loading() {
  return (
    <div className="max-w-md mx-auto space-y-6">
      ...
      {/* Main Card Skeleton */}
      <div className="relative bg-bg-card dark:bg-zinc-900 border border-border-subtle dark:border-white/5 rounded-2xl overflow-hidden shadow-xl aspect-square md:aspect-video flex flex-col items-center justify-center space-y-4 p-8">
        <Skeleton className="w-24 h-24 rounded-full bg-zinc-200 dark:bg-zinc-800" />
        ...
        <div className="grid grid-cols-5 gap-3">
          {[...Array(5)].map((_, i) => (
            <div key={i} className="flex flex-col items-center gap-2">
              <Skeleton className="w-14 h-14 rounded-2xl bg-zinc-200 dark:bg-zinc-800" />
