    ...
    <div className="max-w-4xl mx-auto space-y-6 animate-in fade-in zoom-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {[...Array(2)].map((_, i) => (
          <div
            key={i}
            className="col-span-1 rounded-3xl border border-border-subtle dark:border-white/10 bg-bg-card dark:bg-zinc-900/50 h-64 p-6 flex flex-col justify-between"
          >
            <div className="flex justify-between items-start">
              <Skeleton className="h-8 w-32 rounded-full bg-zinc-200 dark:bg-zinc-800" />
            ...
            <div>
              ...
              <Skeleton className="h-6 w-40 mb-1 bg-zinc-200 dark:bg-zinc-800" />
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="col-span-2 md:col-span-4 rounded-3xl bg-bg-card dark:bg-zinc-900/40 border border-border-subtle dark:border-white/5 p-6 space-y-6">
          ...
          <div className="space-y-4">
            {[...Array(3)].map((_, i) => (
              <div
                key={i}
                className="flex items-center gap-4 p-4 rounded-2xl bg-zinc-50/50 dark:bg-white/5 border border-border-subtle dark:border-white/5"
              >
                <Skeleton className="w-14 h-14 rounded-xl bg-zinc-200 dark:bg-zinc-800" />
